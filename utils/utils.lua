...
function TALCUtils:Init()
    ...
    core.equipSlotsDetails = {
        ...
        ["INVTYPE_CHEST"] = { slot = "Chest", id = 5, canHaveEnchant = true, name = 'Chest' },
        ["INVTYPE_ROBE"] = { slot = "Chest", id = 5, canHaveEnchant = true, name = 'Robe' },
        ["INVTYPE_WAIST"] = { slot = "Waist", id = 6, canHaveEnchant = false, name = 'Waist' },
        ["INVTYPE_LEGS"] = { slot = "Legs", id = 7, canHaveEnchant = true, name = 'Legs' },
        ["INVTYPE_FEET"] = { slot = "Feet", id = 8, canHaveEnchant = true, name = 'Feet' },
        ["INVTYPE_WRIST"] = { slot = "Wrist", id = 9, canHaveEnchant = true, name = 'Wrists' },
        ["INVTYPE_HAND"] = { slot = "Hands", id = 10, canHaveEnchant = true, name = 'Hands' },

        ["INVTYPE_FINGER0"] = { slot = "Finger0", id = 11, canHaveEnchant = false, name = 'Ring' },
        ["INVTYPE_FINGER1"] = { slot = "Finger1", id = 12, canHaveEnchant = false, name = 'Ring' },
        ["INVTYPE_FINGER"] = { slot = "Finger1", id = 12, canHaveEnchant = false, name = 'Ring' },

        ["INVTYPE_TRINKET0"] = { slot = "Trinket0", id = 13, canHaveEnchant = false, name = 'Trinket' },
        ["INVTYPE_TRINKET1"] = { slot = "Trinket1", id = 14, canHaveEnchant = false, name = 'Trinket' },
        ["INVTYPE_TRINKET"] = { slot = "Trinket1", id = 14, canHaveEnchant = false, name = 'Trinket' },

        ["INVTYPE_CLOAK"] = { slot = "Back", id = 15, canHaveEnchant = true, name = 'Cloak' },

        ["INVTYPE_2HWEAPON"] = { slot = "MainHand", id = 16, canHaveEnchant = true, name = 'Two-Hand' },
        ["INVTYPE_WEAPONMAINHAND"] = { slot = "MainHand", id = 16, canHaveEnchant = true, name = 'Main-Hand' },
        ...
        ["INVTYPE_HOLDABLE"] = { slot = "SecondaryHand", id = 17, canHaveEnchant = false, name = 'Held in Off-hand' },

        ["INVTYPE_RANGED"] = { slot = "Ranged", id = 18, canHaveEnchant = false, name = 'Ranged' },
        ["INVTYPE_THROWN"] = { slot = "Ranged", id = 18, canHaveEnchant = false, name = 'Thrown' },
        ["INVTYPE_RANGEDRIGHT"] = { slot = "Ranged", id = 18, canHaveEnchant = false, name = 'Ranged' },
        ["INVTYPE_RELIC"] = { slot = "Ranged", id = 18, canHaveEnchant = false, name = 'Relic/Totem/Idol/Sigil' },
        ["INVTYPE_TABARD"] = { slot = "Tabard", id = 19, canHaveEnchant = false, name = 'Tabard' },
    }
    ...
    core.getAverageItemLevel = function(target)
        ...
        if numItems > 0 then
            return math.floor(itemLevel / numItems)
        end
        return 0
    end
